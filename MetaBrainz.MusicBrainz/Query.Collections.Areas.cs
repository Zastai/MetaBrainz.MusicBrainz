...
public sealed partial class Query {
  ...
  public Task<string> AddToCollectionAsync(string client, Guid collection, params IArea[] areas) {
    var submission = new ModifyCollection(HttpMethod.Put, client, collection, EntityType.Area).Add(areas);
  ...
  public Task<string> RemoveFromCollectionAsync(string client, Guid collection, params IArea[] areas) {
    var submission = new ModifyCollection(HttpMethod.Delete, client, collection, EntityType.Area).Add(areas);
    return this.PerformSubmissionAsync(submission);
  }
