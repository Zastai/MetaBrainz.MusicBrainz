...
public sealed partial class Query {
  ...
  /// </para>
  /// </remarks>
  public IStreamingQueryResults<ISearchResult<IWork>> FindAllWorks(string query, int? pageSize = null, int? offset = null,
                                                                   bool simple = false)
    => new FoundWorks(this, query, pageSize, offset, simple).AsStream();

  /// <inheritdoc cref="FindWorksAsync"/>
