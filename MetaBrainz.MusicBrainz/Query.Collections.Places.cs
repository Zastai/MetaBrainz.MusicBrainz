...
public sealed partial class Query {
  ...
  public Task<string> AddToCollectionAsync(string client, Guid collection, params IPlace[] places) {
    var submission = new ModifyCollection(HttpMethod.Put, client, collection, EntityType.Place).Add(places);
  ...
  public Task<string> RemoveFromCollectionAsync(string client, Guid collection, params IPlace[] places) {
    var submission = new ModifyCollection(HttpMethod.Delete, client, collection, EntityType.Place).Add(places);
    return this.PerformSubmissionAsync(submission);
  }
