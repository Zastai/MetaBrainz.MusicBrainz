...
public sealed partial class Query {
  ...
  /// </para>
  /// </remarks>
  public IStreamingQueryResults<ISearchResult<IUrl>> FindAllUrls(string query, int? pageSize = null, int? offset = null,
                                                                 bool simple = false)
    => new FoundUrls(this, query, pageSize, offset, simple).AsStream();
  ...
  public ISearchResults<ISearchResult<IUrl>> FindUrls(string query, int? limit = null, int? offset = null, bool simple = false)
    => AsyncUtils.ResultOf(this.FindUrlsAsync(query, limit, offset, simple));
