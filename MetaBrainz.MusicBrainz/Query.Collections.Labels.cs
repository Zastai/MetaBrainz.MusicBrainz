...
public sealed partial class Query {
  ...
  public Task<string> AddToCollectionAsync(string client, Guid collection, params ILabel[] labels) {
    var submission = new ModifyCollection(HttpMethod.Put, client, collection, EntityType.Label).Add(labels);
  ...
  public Task<string> RemoveFromCollectionAsync(string client, Guid collection, params ILabel[] labels) {
    var submission = new ModifyCollection(HttpMethod.Delete, client, collection, EntityType.Label).Add(labels);
    return this.PerformSubmissionAsync(submission);
  }
