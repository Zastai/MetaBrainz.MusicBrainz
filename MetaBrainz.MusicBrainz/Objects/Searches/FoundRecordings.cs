...
namespace MetaBrainz.MusicBrainz.Objects.Searches {
  ...
  internal sealed class FoundRecordings : SearchResults<IFoundRecording> {
    ...
    protected override ISearchResults<IFoundRecording> Deserialize(string json) {
      this._currentResult = JsonConvert.DeserializeObject<JSON>(json);
      return this;
    }

    public override IReadOnlyList<IFoundRecording> Results => this._currentResult?.results;
