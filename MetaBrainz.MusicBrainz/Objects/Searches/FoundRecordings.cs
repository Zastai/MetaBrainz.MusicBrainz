...
namespace MetaBrainz.MusicBrainz.Objects.Searches {
  ...
  using Interface = ISearchResults<IFoundRecording>;
  #if NETFX_GE_4_5
  using Results   = IReadOnlyList<IFoundRecording>;
  #else
  using Results   = IEnumerable<IFoundRecording>;
  #endif

  internal sealed partial class FoundRecordings : SearchResults<IFoundRecording> {

    public FoundRecordings(Query query, string queryString, int? limit = null, int? offset = null) : base(query, "recording", queryString, limit, offset) { }
