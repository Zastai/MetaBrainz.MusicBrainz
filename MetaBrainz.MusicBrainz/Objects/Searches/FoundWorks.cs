...
namespace MetaBrainz.MusicBrainz.Objects.Searches {
  ...
  using Interface = ISearchResults<IFoundWork>;
  #if NETFX_GE_4_5
  using Results   = IReadOnlyList<IFoundWork>;
  #else
  using Results   = IEnumerable<IFoundWork>;
  #endif

  internal sealed partial class FoundWorks : SearchResults<IFoundWork> {

    public FoundWorks(Query query, string queryString, int? limit = null, int? offset = null) : base(query, "work", queryString, limit, offset) { }
