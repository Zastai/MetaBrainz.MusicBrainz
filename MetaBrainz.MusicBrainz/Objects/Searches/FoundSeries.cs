...
namespace MetaBrainz.MusicBrainz.Objects.Searches {
  ...
  using Interface = ISearchResults<IFoundSeries>;
  #if NETFX_GE_4_5
  using Results   = IReadOnlyList<IFoundSeries>;
  #else
  using Results   = IEnumerable<IFoundSeries>;
  #endif

  internal sealed partial class FoundSeries : SearchResults<IFoundSeries> {
