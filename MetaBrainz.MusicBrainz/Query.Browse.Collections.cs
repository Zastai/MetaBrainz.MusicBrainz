...
public sealed partial class Query {
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(IArtist,int?,int?)"/>
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(IEvent,int?,int?)"/>
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(IInstrument,int?,int?)"/>
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(ILabel,int?,int?)"/>
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(IPlace,int?,int?)"/>
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(IRecording,int?,int?)"/>
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(IRelease,int?,int?)"/>
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(IReleaseGroup,int?,int?)"/>
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(ISeries,int?,int?)"/>
  ...
  /// <inheritdoc cref="BrowseCollectionsAsync(IWork,int?,int?)"/>
