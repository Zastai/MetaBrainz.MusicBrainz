...
public sealed partial class Query {
  ...
  public Task<string> AddToCollectionAsync(string client, Guid collection, params IEvent[] events) {
    var submission = new ModifyCollection(HttpMethod.Put, client, collection, EntityType.Event).Add(events);
  ...
  public Task<string> RemoveFromCollectionAsync(string client, Guid collection, params IEvent[] events) {
    var submission = new ModifyCollection(HttpMethod.Delete, client, collection, EntityType.Event).Add(events);
    return this.PerformSubmissionAsync(submission);
  }
