...
public sealed partial class Query {
  ...
  /// <inheritdoc cref="BrowseCollectionSeriesAsync"/>
  ...
  public Task<IBrowseResults<ISeries>> BrowseCollectionSeriesAsync(Guid mbid, int? limit = null, int? offset = null,
                                                                   Include inc = Include.None)
    => new BrowseSeries(this, Query.BuildExtraText(inc, "collection", mbid), limit, offset).NextAsync();

  /// <inheritdoc cref="BrowseSeriesAsync"/>
  ...
  public Task<IBrowseResults<ISeries>> BrowseSeriesAsync(ICollection collection, int? limit = null, int? offset = null,
                                                         Include inc = Include.None)
    => new BrowseSeries(this, Query.BuildExtraText(inc, "collection", collection.Id), limit, offset).NextAsync();
